...
export const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                ...
                {roomsDummyData.map((room) => (
                    ...
                    border-b border-gray-300 last:pb-30 last:border-0">
                        ...
                        <div className="md:w-1/2 flex flex-col gap-2">
                            ...
                            {/* Room Amenities */}
                            <div className="flex flex-wrap items-center mt03 mb-6 gap-4">
            ...
            {/* Filter Box */}
            <div className="w-full lg:w-80 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden mb-8 lg:mt-16">
                {/* Filter Header */}
                <div className={`flex items-center justify-between px-5 py-3 bg-gray-50 border-b border-gray-200`}>
                    ...
                    <div className="text-xs cursor-pointer">
                        ...
                        <span 
                            ...
                            className="hidden lg:inline-block cursor-pointer hover:text-blue-500"
                        >
                            CLEAR ALL
                        </span>
                    </div>
                ...
                <div className={`${openFilters ? 'block' : 'hidden lg:block'} transition-all duration-300`}>
                    <div className="px-5 py-4">
                        <h4 className="font-medium text-gray-800 pb-2">Room Type</h4>
                    ...
                    <div className="px-5 py-4 border-t border-gray-100">
                        <h4 className="font-medium text-gray-800 pb-2">Price Range</h4>
                    ...
                    <div className="px-5 py-4 border-t border-gray-100">
                        <h4 className="font-medium text-gray-800 pb-2">Sort By</h4>
